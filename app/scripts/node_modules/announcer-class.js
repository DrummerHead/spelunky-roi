...
/**
 * Send message to all items that they should deselect()
 * @see module:item-class~Item#deselect
 */
Announcer.prototype.deselectAllItems = function(){
  var i, l;
  for(i = 0, l = this.data.consumable.length; i < l; i++){
    this.data.consumable[i].data.deselect();
  }
  for(i = 0, l = this.data.treasure.length; i < l; i++){
    this.data.treasure[i].data.deselect();
  }
};
